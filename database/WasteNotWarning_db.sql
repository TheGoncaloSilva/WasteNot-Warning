...
CREATE TABLE MANUTENCOES(
	...
	[EstadoManutencao_Descricao] VARCHAR(64) REFERENCES ESTADO_MANUTENCAO(Descricao),
	[AreaRestrita_Id] INTEGER REFERENCES AREA_RESTRITA(Id)
);
...
CREATE TABLE DISPOSITIVO_SEGURANCA(
	[Dispositivo_Mac] VARCHAR(?) PRIMARY KEY REFERENCES DISPOSITIVO(Mac),
	[TipoDispositivoSeguranca_Descricao] REFERENCES TIPO_DISPOSITIVO_SEGURANCA(Descricao),
	[AreaRestrita_Id] INTEGER REFERENCES AREA_RESTRITA(Id)
);
